...
Similar maps for other large-extent storms are given in Figure~S3\todo[inline]{Check fig ref}.}
...
(2005), and Katrina (2005) (Figure~S3\todo[inline]{Check fig ref}).} 
\label{fig:jaccard}
\end{figure}
...
Figure~S5\todo[inline]{Check fig ref}).} 
...
Figure~\ref{fig:windexamples}\todo[inline]{Fix fig ref}.}
