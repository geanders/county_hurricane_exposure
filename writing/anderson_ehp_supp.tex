...
metrics are available (1996\,--\,2011).} 
...
storm. The color of each county in the map gives the cumulative precipitation
(in \si{\milli\metre}). The blue outline identifies the collection of counties
that were classified as ``exposed" based on our rainfall criteria (Table 1 of
main text). }
