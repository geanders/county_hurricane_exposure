...
**Events are listed in this database based on reports from ... and other
sources.** While this database has recorded storm data, particularly tornadoes,
since 1950, its coverage changed substantially in 1996 to cover more types of
storm events, including flood events (NOAA NCEI 2020). We therefore only
...
available for the country (the SPC's ...), which provides a version of the 
