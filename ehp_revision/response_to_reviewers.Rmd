...
This is an excellent point. We have add text to the Discussion: 

The dataset we present here provides exposure assessments at the county level.
This spatial scale allows for easy integration with health outcome data
aggregated at the county level. Such aggregated or ecological data is often used
...
county, but it will be unlikely that a county will have one area that is exposed
to extremes of these hazards from a tropical cyclone while other parts of the
county are completely unexposed, as both the wind fields and rain fields of
...
is prone to ecological bias [@greenland1994invited; @portnov2007ecological].
