...
and \@ref(fig:fig5check2) show what Figure 5 of the main text would look like
under three common types of color vision deficiency and when printed in black
and white. Figures \@ref(fig:fig6check1) and \@ref(fig:fig6check2) show the same
thing for Figure 6 of the main text. Therefore, these figures should not require
any exemption from accessibility requirements, as they should satisfy these
requirements.
