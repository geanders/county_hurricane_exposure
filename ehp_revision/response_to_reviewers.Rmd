...
In Figure [x] of this response document, we have reproduced the current version of 
each figure as it would appear to someone with [vision impairment]. 

In Figure [x] of this response document, we have reproduced the current version of 
each figure as it will appear when printed using grayscale (i.e., with most black and 
white printers). 
