...
\textbf{Methods:} We created an open-source dataset with data at the county level on
	...
	metrics, as well as compared them to use of distance from the storm's track, which has 
	been used as a proxy for exposure in some epidemiologic studies.\\ 
